...
import { IonGrid, IonModal, IonCol, IonRow, IonToolbar, IonHeader, IonButtons, IonButton, IonTitle, IonContent, IonList, IonItem, IonLabel } from "@ionic/angular/standalone";

@Component({
  selector: 'app-socialstats',
  imports: [IonLabel, IonItem, IonList, IonContent, IonTitle, IonButton, IonButtons, IonHeader, IonToolbar, IonRow, IonCol, IonModal, IonGrid, CommonModule],
  standalone: true,
